...
import IBook, { BookCondition, BookConditions, BookLanguage, BookLanguages, BookLegibility, BookLegibilitys } from "../../models/book"
        ...
        <div id="add_book" className="page">
            ...
            <form action="" id="add-book-form">
                ...
                <select id="legibilitySelect" value={book.legibility} onChange={handleLegibility}>
                    {
                        BookLegibilitys.map((legibility, index) => {
                            return (
