                ...
                user && menu &&(
                    <div className="overlay" onClick={() => setMenu(false)}>
                        <div className="menu" onClick={(e) => {
                            ...
                            <span className="signed-as">Signed in as <b>{user.username}</b></span>
                            <ol>
